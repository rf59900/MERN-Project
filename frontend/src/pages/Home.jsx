        ...
        <div className="container mt-2">
            ...
            <div className="row justify-content-center mt-5">
                <div className="col-6 text-center border">
                    ...
                    <div className="row border-bottom" onClick={() => handleLinkToBoard('a')} style={{cursor: 'pointer'}}>
                        <div className="col-3 py-1 border-end">
                    ...
                    <div className="row border-bottom" onClick={() => handleLinkToBoard('f')} style={{cursor: 'pointer'}}>
                        <div className="col-3 py-1 border-end">
                    ...
                    <div className="row border-bottom" onClick={() => handleLinkToBoard('t')} style={{cursor: 'pointer'}}>
                        <div className="col-3 py-1 border-end">
                    ...
                    <div className="row border-bottom" onClick={() => handleLinkToBoard('o')} style={{cursor: 'pointer'}}>
                        <div className="col-3 py-1 border-end">
                    ...
                    <div className="row border-bottom" onClick={() => handleLinkToBoard('c')} style={{cursor: 'pointer'}}>
                        <div className="col-3 py-1 border-end">
